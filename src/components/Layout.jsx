        ...
        <div className="mx-auto max-w-7xl flex items-center justify-between">
          ...
          <div className="flex items-center justify-between w-full">
            ...
            <div className="flex items-center gap-2 shrink-0">
              ...
              <button className="w-10 h-10 rounded-full bg-white/80 backdrop-blur-md text-slate-500 shadow-sm border border-white/50 hidden items-center justify-center relative hover:bg-white transition-colors">
                ...
                {unreadCount > 0 && <span className="absolute top-2.5 right-2.5 w-2 h-2 bg-[#ff9871] rounded-full"></span>}
              </button>
            </div>
          </div>
        </div>
